...
dfp %>%
  ...
  summarize(
    ...
    .by=c(race_ethnicity, is_ell)#, has_disability, is_disadvantaged)
    ) %>% 
  arrange(race_ethnicity, is_ell)#, has_disability, is_disadvantaged)
...
labels <- c("(Intercept)",
            ...
            "Transformer[Hispanic]:White",
            "Transformer[White]:White",
